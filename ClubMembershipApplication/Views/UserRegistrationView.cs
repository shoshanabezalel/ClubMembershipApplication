...
namespace ClubMembershipApplication.Views
{
    public class UserRegistrationView : IView
    {
        ...
        public void RunView()
        {
            ...
            _fieldValidator.FieldArray[(int)FieldConstants.UserRegistrationField.PostCode] = GetInputFromUser(FieldConstants.UserRegistrationField.PostCode, "Please enter the city where you live");
        ...
        private void RegisterUser()
        {
            ...
            CommonOutputFormat.ChangeFrontColor(FontTheme.Success);
